...
const TextGenerator: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // assume backend returns { text: 'generated content' } or { result: '...' }
      const generated = data.text ?? data.result ?? data.generated ?? data;
      const display = typeof generated === 'string' ? generated : JSON.stringify(generated, null, 2);
      setResult(display);
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-12">
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6">
        <h1 className="text-2xl font-semibold mb-4">✨ KLYA AI — Smart Content Generator</h1>
